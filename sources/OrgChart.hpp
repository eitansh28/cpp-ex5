...
namespace ariel{
    ...
    public:
        ...
        OrgChart& add_sub(const string &commander, const string &subordinate);
        bool findingFather(Node* curr, const string &com, const string &sub);
	...
	private:
        Node* pointer_to_current_node=NULL;
        queue<Node*>Queue;
        stack<Node*>Stack;
        vector<Node*>runrev;
        int flag=0;
